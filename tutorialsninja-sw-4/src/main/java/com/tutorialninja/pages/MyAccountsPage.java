...
public class MyAccountsPage extends Utility {
    ...
    public void setTelephone(){
        sendTextToElement(telephone, "07576893453");
    }

    public void setPassword(){
        sendTextToElement(password, "shy123");
    }

    public void setConfirmPassword(){
        sendTextToElement(confirmPassword, "shy123");
    }

    public void subscribe(){
        selectByContainsTextFromListOfElements(subscribe, "Yes");
    }
